...
class Uelektrik extends CI_Controller {
	...
	public function load()
	{
		...
		$query = $this->db->query("SELECT unit,kw,class,starter,mccb,kontaktor_line,kontaktor_delta,kontaktor_star,kabel,jumlah_kabel FROM master_unit_elektrik where id_pabrik = '$id_pabrik' AND id_station = '$id_station'");
